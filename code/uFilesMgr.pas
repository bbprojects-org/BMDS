{ ==============================================================================
  ...
  FILES MANAGER
    ...
    Loads machine files checking CRC where provided (ROM files, etc)
...
{ Code based on 'http://www.efg2.com/Lab/Mathematics/CRC.htm' }
...
begin
  ...
  for i := 0 to (strm.Size - 1) do
    begin
      Result := (Result shr 8) xor CRC_32_TABLE[q^ xor (Result and $000000FF)];
      inc(q);
    end;
  Result := not Result;
end;
...
begin
  ...
  try
    ...
    FileStream.Free;                    // Ensure memstream freed, even if error
  end;
end;
